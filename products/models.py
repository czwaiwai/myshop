...
class Product(models.Model):
    ...
    brand = models.ForeignKey(Brand, on_delete=models.CASCADE, related_name='products', verbose_name='商品品牌')
    sales = models.IntegerField(default=0, verbose_name='商品销量')
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='商品价格')
    origin_price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='商品原价')
...
class ProductSKU(models.Model):
    ...
    attributes = models.ManyToManyField(ProductAttributeValue, related_name='skus', verbose_name='SKU属性')
