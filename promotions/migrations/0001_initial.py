    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('percent', '百分比折扣'), ('fixed', '固定金额折扣')], max_length=100, verbose_name='优惠类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='promotions.coupon', verbose_name='优惠券')),
